...
@Component
public class MLBCrawler implements NewsCrawler {
	private static final Logger LOG = LoggerFactory.getLogger(MLBCrawler.class);
	private static String LA = "http://mlb.mlb.com/partnerxml/gen/news/rss/la.xml";
	private static String TEX = "http://mlb.mlb.com/partnerxml/gen/news/rss/tex.xml";
	private static String BAL = "http://mlb.mlb.com/partnerxml/gen/news/rss/bal.xml";
	...
	public List<Article> createArticlList() {
		...
		createListBySection(LA, ArticleSection.SPORT);
		createListBySection(TEX, ArticleSection.SPORT);
		createListBySection(BAL, ArticleSection.SPORT);
