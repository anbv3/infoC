...
public class Collector {
	public static Map<Integer, List<Article>> CACHE = 
	...
	private static Splitter SPLITTER = Splitter.onPattern(DUP_PATTERN).trimResults().omitEmptyStrings();
	...
	public static void add(Article newArticle) {
		...
		if(isNew) {
			...
			Collector.CACHE.get(hour).add(newArticle);
		}
	}
